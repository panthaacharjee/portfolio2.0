           ...
           <div className="content">
                <div >
                    ...
                    <div className=" flex justify-center items-center mt-6 mb-14 ">
                      ...
                      <a download href="https://drive.google.com/file/d/1zFaiwcUmwN0SvWXkJcMQLsKTtxhQQETC/view" className="text-white hover:text-lg"><i className="ri-file-list-2-line"></i> <span>Resume</span></a>
                </div>
           </div>
        </div>
    </div>
